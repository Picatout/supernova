...
\ PORT B REGISTERS 
$5005 DUP CONSTANT PB-ODR \ OUTPUT DATA REG.
1+ DUP CONSTANT PB-IDR \ INPUT DATA REG.
1+ DUP CONSTANT PB-DDR \ DATA DIRECTION REG.
1+ DUP CONSTANT PB-CR1 \ CONTROL REG. 1
1+ CONSTANT PB-CR2 \ CONTROL REG. 2
...
\ TIMER 3 REGISTERS
$5320 DUP CONSTANT T3-CR1 \ CONTROL REG. 1
1+ DUP CONSTANT T3-IER  \ INTERRUPT ENABLE REGISTER
1+ DUP CONSTANT T3-SR1 \ STATUS REGISTER 1
1+ DUP CONSTANT T3-SR2 \ STATUS REGISTER 2
1+ DUP CONSTANT T3-EGR \ EVENT GENERATOR
1+ DUP CONSTANT T3-CCMR1 \ CAPTURE/COMPARE MODE CHANNEL 1
1+ DUP CONSTANT T3-CCMR2 \ CAPTURE/COMPARE MODE CHANNEL 2
1+ DUP CONSTANT T3-CCER1 \ CAPTURE/COMPARE ENABLE REG. 1
1+ DUP CONSTANT T3-CNTRH \ COUNTER HIGH
1+ DUP CONSTANT T3-CNTRL \ COUNTER LOW
1+ DUP CONSTANT T3-PSCR \ CLOCK PRESCALER
1+ DUP CONSTANT T3-ARRH \ AUTO-RELOAD PERIOD REG. HIGH
1+ DUP CONSTANT T3-ARRL \ AUTO-RELOAD PERIOD REG. LOW
1+ DUP CONSTANT T3-CCR1H \ CAPTURE/COMPARE VALUE CH. 1 HIGH
1+ DUP CONSTANT T3-CCR1L \ CAPTURE/COMPARE VALUE CH. 1 LOW
1+ DUP CONSTANT T3-CCR2H \ CAPTURE/CAMPARE VALUE CH. 2 HIGH
1+ CONSTANT T3-CCR2L \ CAPTURE/COMPARE VALUE CH. 2 LOW

\ ADC REGISTERS
$53E0 DUP CONSTANT ADC-DBR \ 20 BYTES DATA REG.
$5400 DUP CONSTANT ADC-CSR \ CONTROL/STATUS REG.
1+ DUP CONSTANT ADC-CR1 \ CONFIG REG. 1
1+ DUP CONSTANT ADC-CR2 \ CONFG REG. 2
1+ DUP CONSTANT ADC-CR3 \ CONFIG REG. 3
1+ DUP CONSTANT ADC-DRH \ DATA REG. HIGH
1+ DUP CONSTANT ADC-DRL \ DATA REG. LOW 
1+ DUP CONSTANT ADC-TDRH \ SCHMITT TRG REG. HIGH
1+ DUP CONSTANT ADC-TDRL \ SCHMITT TRG REG. LOW
1+ DUP CONSTANT ADC-HTRH \ HIGH THRHOLD REG. HIGH
1+ DUP CONSTANT ADC-HTRL \ HIGH THRHOLD REG. LOW
1+ DUP CONSTANT ADC-LTRH \ LOW THRHOLD REG. HIGH
1+ DUP CONSTANT ADC-LTRL \ LOW THRHOLD REG. LOW
1+ DUP CONSTANT ADC-AWSRH \ WDG STATUS HIGH
1+ DUP CONSTANT ADC-AWSRL \ WDG STATUS LOW
1+ DUP CONSTANT ADC-AWCRH  \ WDG CONTROL HIGH 
1+ CONSTANT ADC-AWCRL \ WDG CONTROL LOW
